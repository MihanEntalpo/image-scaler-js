...
Новая задача:
- Сделать сантиметровые риски на линейке заметно толще, чем миллиметровые.
- Превратить кнопки поворота и изменения длины линейки в иконки с прозрачным фоном и без рамок.

Новая задача:
- Уточнить инструкции в `AGENTS.md`, чтобы перед стартом работы обязательно перечитывали и `workflow.md`, и `tasks.md`, а каждую новую активную задачу фиксировали в `tasks.md` отдельным блоком.
- Сделать так, чтобы у горизонтальной линейки сантиметровые риски были такими же толстыми и заметными, как у вертикальной.
- Настроить миллиметровые риски линейки: они должны быть полупрозрачными и иметь длину, равную половине толщины линейки.

Новая задача:
- Исправить работу линейки при повороте и изменении длины: её визуальный размер и ориентация должны обновляться сразу после действия пользователя, без необходимости дополнительно перетаскивать линейку.
